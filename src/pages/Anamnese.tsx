...
const Question = ({ number, text, showFollowUp, followUpText, followUpValue, onValueChange, followUpPlaceholder }) => {
    ...
    return (
        /*<View style={{ marginBottom: 20 }}>
          <Text style={{ fontSize: 16 }}>{number}. {text}</Text>
          <Picker
            ...
            >
              <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#000000aa' }}>
                <View style={{ backgroundColor: 'white', padding: 20, borderRadius: 10, width: '80%' }}>
                  ...
                  />
                  <Text onPress={() => setModalVisible(false)} style={{ textAlign: 'right', color: '#007bff' }}>OK</Text>
                </View>
              </View>
            </Modal>
          )}
    ...
    return (
        <LinearGradient colors={['#79DDF3', '#5E845F']} style={styles.container1}>
            <ScrollView contentContainerStyle={{ padding: 20 }}>
                ...
                {/*<View style={{ marginBottom: 20 }}>
                    <Text style={{ fontSize: 16 }}>10. Por favor insira aqui o seu:</Text>
                    <Text>Peso atual (kg):</Text>
                    <TextInput
...
const styles = StyleSheet.create({
    ...
    header: {
        backgroundColor: '#0D2C54', // azul escuro
        padding: 2,
        height: 22
    },
    ...
    picker: {
        color: '#0D2C54', // azul escuro
        fontWeight: 'bold',
    },

   separator: {
        borderBottomWidth: 1,
        borderBottomColor: '#123765',
        marginHorizontal: 10,
    },
